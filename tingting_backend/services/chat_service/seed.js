...
const conversations = [
    {
        ...
        participants: [
            { userId: "6601a1b2c3d4e5f678901238", role: "admin", mute: "1h" },
            { userId: "6601a1b2c3d4e5f678901239", role: "member", mute: null },
        ],
        lastMessage: null,
        isHidden: false,
        isPinned: false,
    ...
    },
    {
        ...
        isGroup: false,
        participants: [
            { userId: "6601a1b2c3d4e5f678901240", mute: null },
            { userId: "6601a1b2c3d4e5f678901241" , mute: null },
        ],
        lastMessage: null,
        createAt: new Date(),
        updateAt: new Date()
